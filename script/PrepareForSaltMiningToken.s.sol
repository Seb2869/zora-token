...
contract MineDeterministicConfig is DeploymentBase {
    ...
    function run() public {
        ...
        printMintSaltCommand(IMMUTABLE_CREATE2_FACTORY_ADDRESS, keccak256(tokenCreationCode), "11111111111", address(0));
        ...
        saveDeterministicConfig(deterministicConfig, ZORA_TOKEN_CONTRACT_NAME);
    }
}
